...
## Statistical Methods 
Linear regression to predict the price of a flight

## Computational Steps
Split data into several smaller files by departing airport. Use best subset or some other technique to chose which variables are significant to price. Fit the model and run diagnostics. Each of these steps will be distributed to the departing airport files.
